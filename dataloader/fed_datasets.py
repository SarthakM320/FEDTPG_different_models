...
class ImageNet(DatasetBase):
    ...
    def __init__(self, cfg,available_classes=None,relabel=True):
        ...
        # root = os.path.abspath(os.path.expanduser(cfg.DATASET.ROOT))
        # self.dataset_dir = os.path.join(root, self.dataset_dir)
        self.dataset_dir = '/raid/biplab/datasets/hassan/imagenet'
        self.image_dir = os.path.join(self.dataset_dir, 'images')
...
class ImageNetA(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        root = os.path.abspath(os.path.expanduser(cfg.DATASET.ROOT))
        # self.dataset_dir = os.path.join(root, self.dataset_dir)
        self.dataset_dir = '/raid/biplab/datasets/hassan/imagenet-adverserial'
...
class ImageNetR(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        root = os.path.abspath(os.path.expanduser(cfg.DATASET.ROOT))
        # self.dataset_dir = os.path.join(root, self.dataset_dir)
        self.dataset_dir = '/raid/biplab/datasets/hassan/imagenet-rendition'
...
class ImageNetSketch(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        root = os.path.abspath(os.path.expanduser(cfg.DATASET.ROOT))
        # self.dataset_dir = os.path.join(root, self.dataset_dir)
        self.dataset_dir = '/raid/biplab/datasets/hassan/imagenet-sketch'
        self.image_dir = os.path.join(self.dataset_dir, "images")
...
class ImageNetV2(DatasetBase):
    ...
    def __init__(self, cfg):
        ...
        root = os.path.abspath(os.path.expanduser(cfg.DATASET.ROOT))
        # self.dataset_dir = os.path.join(root, self.dataset_dir)
        self.dataset_dir = '/raid/biplab/datasets/hassan/imagenetv2'
