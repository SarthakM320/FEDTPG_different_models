...
class TestDataManager:
    ...
    def __init__(
        ...
        dataset_classnum = {'imagenet': 1000, 'caltech101':100, 'oxford_flowers': 102,'eurosat':10, 'oxford_pets':37, 'fgvc_aircraft': 100,
                            'food101': 101, 'dtd': 47, 'ucf101':101,'stanford_cars':196,'sun397':397 ,'imagenet-adverserial': 200,'imagenet-sketch': 200,'imagenet-rendition': 200,'imagenetv2': 200}
        # Load dataset
        ...
        for dataname in available_datasets:
            ...
            elif dataname == 'imagenet-adverserial':
                dataset = ImageNetA(cfg)
            elif dataname == 'imagenet-rendition':
                dataset = ImageNetR(cfg)
            elif dataname == 'imagenet-sketch':
                dataset = ImageNetSketch(cfg)
            elif dataname == 'imagenetv2':
